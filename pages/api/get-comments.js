...
export default async function handler(req, res) {
  ...
  try {
    ...
    const latestCommentsOfContacts = data?.data?.contacts
      ?.filter(
        (contact) =>
          contact.latestEvent.formId ===
            "f_b0545b9c-d002-462d-baa2-21be06d7a40d" &&
